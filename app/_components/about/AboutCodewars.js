...
export default function AboutCodewars({ addBorder }) {
  return (
    <div
      className={`w-full overflow-hidden relative h-full rounded-2xl p-5 text-l md:text-normal  text-textColor dark:text-textColorDark  bg-bgColor dark:bg-bgColorDark ${
        addBorder
